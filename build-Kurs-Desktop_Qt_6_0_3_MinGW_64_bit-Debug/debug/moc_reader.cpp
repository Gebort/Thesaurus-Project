...
QT_MOC_LITERAL(7, 9), // "wordReady"
QT_MOC_LITERAL(17, 0), // ""
QT_MOC_LITERAL(18, 4), // "word"
QT_MOC_LITERAL(23, 8), // "finished"
QT_MOC_LITERAL(32, 8) // "getWords"

    },
    "Reader\0wordReady\0\0word\0finished\0"
    "getWords"
};
...
void Reader::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->wordReady((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->finished(); break;
        case 2: _t->getWords(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Reader::wordReady)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Reader::wordReady(QString _t1)
{
